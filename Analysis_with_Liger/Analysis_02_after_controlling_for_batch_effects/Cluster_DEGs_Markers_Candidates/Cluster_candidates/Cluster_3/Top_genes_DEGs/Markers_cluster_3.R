...
GEP_markers = read.csv("/home/yasir/Documents/Chapter1/Liger_analysis_strategy_1/Results/Analysis_of_WT_Cardamine/Remove_rep_specific_GEP20_and_22/Cluster_biomarkers/Cluster_3/Top_genes_GEP_identity/GEP_43/Cluster_3_GEP_43_markers.csv", row.names = 1)
...
names(specific_markers_list)[4]

Cluster_marker = specific_markers_list[[4]]
