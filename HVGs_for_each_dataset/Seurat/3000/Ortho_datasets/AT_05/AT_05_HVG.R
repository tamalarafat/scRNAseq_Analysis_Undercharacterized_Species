...
COL_HVGs = variableGenes_seurat(dataObject = COL_5E, nfeatures = 3000)
fileGenerator(COL_HVGs, fileName = "AT_5E_3000_HVG_seurat.txt")

mean_var_COL_5E = loadRData("/home/ytamal2/Documents/2022/Final_part_PhD_Thesis/Analyses/HVGs_for_each_dataset/Liger/3000/Ortho_datasets/AT_05/Mean_Variance_AT_05.RData")

seurat_mean_var_COL_5E = get_variableGenes_info(COL_5E)
save(seurat_mean_var_COL_5E, file = "Seurat_Mean_Variance_AT_05.RData")

VariableFeaturePlot(COL_5E)
...
ggsave(plot = p, filename = "COL_5E_Seurat_HVG_sm.png", width = 12, height = 12, dpi = 300)
...
ggsave(plot = p, filename = "COL_5E_Seurat_HVG.png", width = 12, height = 12, dpi = 300)
