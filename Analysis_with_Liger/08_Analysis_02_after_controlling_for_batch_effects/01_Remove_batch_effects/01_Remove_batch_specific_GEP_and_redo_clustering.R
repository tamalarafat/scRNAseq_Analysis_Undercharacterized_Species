...
integrated.data@reductions[["inmfcc"]]@cell.embeddings <- integrated.data@reductions[["inmfcc"]]@cell.embeddings[, -c(20, 22)]
...
save(integrated.data, file = "seurat_object_of_K_44_Without_GEP20.RData")
