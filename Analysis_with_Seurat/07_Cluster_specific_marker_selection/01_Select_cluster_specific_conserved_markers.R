...
DEG_dir = paste0(project_dir, "Analysis_of_single_species_Cardamine/Analysis_with_Seurat/Analysis_outputs/Differentially_expressed_genes/Conserved_marker_grouped_by_Genotype/Conserved_markers_DEtest_wilcox")
