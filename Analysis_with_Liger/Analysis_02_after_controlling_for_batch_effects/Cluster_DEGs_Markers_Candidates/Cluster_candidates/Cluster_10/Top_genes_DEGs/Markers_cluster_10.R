...
GEP_markers = read.csv("/home/yasir/Documents/Chapter1/Liger_analysis_strategy_1/Results/Analysis_of_WT_Cardamine/Remove_rep_specific_GEP20_and_22/Cluster_biomarkers/Cluster_10/Top_genes_GEP_identity/GEP_10/Cluster_10_GEP_10_markers.csv", row.names = 1)
