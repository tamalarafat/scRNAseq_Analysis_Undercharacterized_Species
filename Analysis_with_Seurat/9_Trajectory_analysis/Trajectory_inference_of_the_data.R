...
# Storing directory
res_dir = "/netscratch/dep_tsiantis/grp_laurent/tamal/2023/Analyses/Analysis_of_single_species_Cardamine/Seurat_Analyses/Seurat_analysis_strategy_1/9_Trajectory_analysis"

############################ Change this chunk ############################
Idents(integrated.data) <- integrated.data$integrated_snn_res.0.4
...
Species_TI <- slingshot(Embeddings(integrated.data, "pca"), clusterLabels = Idents(integrated.data), start.clus = 15, stretch = 0, maxit = 10)
