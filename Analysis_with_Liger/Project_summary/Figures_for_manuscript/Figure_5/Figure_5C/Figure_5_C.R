...
ggsave(plot = p, filename = "Figure_5C_1.png", width = 6, height = 6, dpi = 300)
...
ggsave(plot = p, filename = "Figure_5C_2.png", width = 6, height = 6, dpi = 300)
...
ggsave(plot = p, filename = "Figure_5C_3.png", width = 6, height = 6, dpi = 300)
...
ggsave(plot = p, filename = "Figure_5C_4.png", width = 6, height = 6, dpi = 300)
