...
p <- FeaturePlot(integrated.data, features = "Cluster6", reduction = "umap", dims = c(1, 2), pt.size = 2, order = T, min.cutoff = 0.001, cols = c("grey", RColorBrewer::brewer.pal(9, "Reds")[9])) + 
  NoLegend() + 
  theme(
    line = element_blank(),
...
ggsave(plot = p, filename = "Figure_4A_modules.png", width = 6, height = 6, dpi = 300)
