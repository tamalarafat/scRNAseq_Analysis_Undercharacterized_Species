...
#### Running suggest K
#### Running suggest K
sg_L <- suggestLambda(wt_hirsuta, k = 50, num.cores = 10)

save(sg_L, file = "suggest_lambda_ox_wt_liger.Rdata")

writeLines(capture.output(sessionInfo()), "Session_info_suggest_lambda_ox_wt_liger.txt")
