...
GEP_markers = read.csv("/home/yasir/Documents/Thesis_PhD/Chapter_1/Remove_GEP20_22_and_CCGEPs/Cluster_DEGs_Markers_Candidates/Cluster_candidates/Cluster_12/Top_genes_GEP_identity/GEP_9/Cluster_12_GEP_9_markers.csv", row.names = 1)
