...
GEP_markers = read.csv("/home/yasir/Documents/Thesis_PhD/Chapter_1/Remove_GEP20_22_and_CCGEPs/Cluster_DEGs_Markers_Candidates/Cluster_candidates/Cluster_11/Top_genes_GEP_identity/GEP_6/Cluster_11_GEP_6_markers.csv", row.names = 1)
