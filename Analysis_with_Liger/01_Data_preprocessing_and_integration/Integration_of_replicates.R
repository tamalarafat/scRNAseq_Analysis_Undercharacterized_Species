...
wt_hirsuta@var.genes <- anchFeatures
...
wt_hirsuta <- optimizeALS(wt_hirsuta, k = 50, nrep = 10, lambda = 5)

# Quantile normalization of the data - integration in the shared space
wt_hirsuta <- quantile_norm(wt_hirsuta)

# Run liger implemented UMAP
wt_hirsuta <- runUMAP(wt_hirsuta)

Liger_object_K_50 <- wt_hirsuta

save(Liger_object_K_50, file = "integrated_ox_wt_liger.RData")
