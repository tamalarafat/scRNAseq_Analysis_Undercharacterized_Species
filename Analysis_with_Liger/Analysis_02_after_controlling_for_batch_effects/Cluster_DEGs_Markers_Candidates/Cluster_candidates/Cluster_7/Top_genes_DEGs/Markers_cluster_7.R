...
GEP_4_markers = read.csv("/home/yasir/Documents/Chapter1/Liger_analysis_strategy_1/Results/Analysis_of_WT_Cardamine/Remove_rep_specific_GEP20_and_22/Cluster_biomarkers/Cluster_7/Top_genes_GEP_identity/GEP_4/Cluster_7_GEP_4_markers.csv", row.names = 1)

GEP_21_markers = read.csv("/home/yasir/Documents/Chapter1/Liger_analysis_strategy_1/Results/Analysis_of_WT_Cardamine/Remove_rep_specific_GEP20_and_22/Cluster_biomarkers/Cluster_7/Top_genes_GEP_identity/GEP_21/Cluster_7_GEP_21_markers.csv", row.names = 1)

GEP_markers = rbind(GEP_21_markers, GEP_4_markers)
