...
save(markers_description, file = "markers_description.RData")
...
arranged_fig <- ggarrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, ncol = 1, nrow = 18, common.legend = TRUE, legend = "none")
my_fig <- annotate_figure(arranged_fig, bottom = text_grob("Cell clusters", size = 44), 
