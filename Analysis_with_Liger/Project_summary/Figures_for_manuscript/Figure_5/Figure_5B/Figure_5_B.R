...
ggsave(plot = p1, filename = str_c("SP_CL8_GEP_", paste(c(5, 11, 27, 29, 33, 44), collapse = "_"), "_2.png"), width = 10, height = 12)
...
ggsave(plot = p1, filename = str_c("SP_CL8_GEP_", paste(c(11, 27, 29, 33, 44), collapse = "_"), "_2.png"), width = 10, height = 12)
