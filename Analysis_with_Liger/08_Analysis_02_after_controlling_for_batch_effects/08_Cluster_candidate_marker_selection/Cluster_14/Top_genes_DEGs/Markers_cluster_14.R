...
GEP_3_markers = read.csv("/home/yasir/Documents/Chapter1/Liger_analysis_strategy_1/Results/Analysis_of_WT_Cardamine/Remove_rep_specific_GEP20_and_22/Cluster_biomarkers/Cluster_14/Top_genes_GEP_identity/GEP_3/Cluster_14_GEP_3_markers.csv", row.names = 1)

GEP_31_markers = read.csv("/home/yasir/Documents/Chapter1/Liger_analysis_strategy_1/Results/Analysis_of_WT_Cardamine/Remove_rep_specific_GEP20_and_22/Cluster_biomarkers/Cluster_14/Top_genes_GEP_identity/GEP_31/Cluster_14_GEP_31_markers.csv", row.names = 1)

GEP_markers = rbind(GEP_3_markers, GEP_31_markers)
...
names(specific_markers_list)[15]

Cluster_marker = specific_markers_list[[15]]
