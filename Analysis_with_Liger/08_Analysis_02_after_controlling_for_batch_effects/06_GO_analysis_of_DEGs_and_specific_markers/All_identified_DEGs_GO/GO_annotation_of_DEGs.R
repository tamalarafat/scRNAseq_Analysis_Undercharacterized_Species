...
load("/home/yasir/Documents/Projects_Yasir/Analysis_of_single_species_Cardamine/Analysis_with_Liger/Analysis_02_after_controlling_for_batch_effects/05_DEGs_and_their_orthologues/DEGs_and_Markers.RData")
