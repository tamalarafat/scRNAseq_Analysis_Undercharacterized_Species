...
ggsave(filename = "Figure_3_STM_cluster_stm_cells_sorted.png", plot = p, width = 12, height = 18, dpi = 300)
...
ggsave(filename = "Figure_3_STM_cluster_only_stm_cells.png", plot = p, width = 12, height = 18, dpi = 300)
