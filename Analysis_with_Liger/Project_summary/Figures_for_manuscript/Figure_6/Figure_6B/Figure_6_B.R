...
Idents(integrated.data) <- factor(Idents(integrated.data), levels = c(0, 10, 14, 16, 1, 2, 3, 12, 17, 7, 8, 4, 11, 9, 15, 13, 6, 5))
...
ggsave(filename = "Figure_6B.png", plot = p, width = 26, height = 20, dpi = 300)
