...
# GEP genes
GEPgenes = read.delim("GEP_28_genes.txt", header = FALSE, col.names = "gene_ID")
...
a = get_GEP_genes(seurat_object = integrated.data, reduction_name = "inmf", GEP_IDs = c(1, 2, 4, 7, 12))
