...
GEP_29_markers = read.csv("/home/yasir/Documents/Chapter1/Liger_analysis_strategy_1/Results/Analysis_of_WT_Cardamine/Remove_rep_specific_GEP20_and_22/Cluster_biomarkers/Cluster_8/Top_genes_GEP_identity/GEP_29/Cluster_8_GEP_29_markers.csv", row.names = 1)

GEP_33_markers = read.csv("/home/yasir/Documents/Chapter1/Liger_analysis_strategy_1/Results/Analysis_of_WT_Cardamine/Remove_rep_specific_GEP20_and_22/Cluster_biomarkers/Cluster_8/Top_genes_GEP_identity/GEP_33/Cluster_8_GEP_33_markers.csv", row.names = 1)

GEP_markers = rbind(GEP_29_markers, GEP_33_markers)
...
names(specific_markers_list)[9]

Cluster_marker = specific_markers_list[[9]]
